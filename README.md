...
```bash
# 1. Clone repository
git clone https://github.com/user/freight-veil.git
cd freight-veil
...
| # | Requirement | Status |
|---|------------|--------|
| 1 | Live demo link | ✅ [freight-veil.vercel.app](https://freight-veil.vercel.app) |
| 2 | Screenshot: test output (3+ tests passing) | ✅ 8/8 tests — see [`screenshots/test_cases.png`](./screenshots/test_cases.png) |
| 3 | Demo video (1 minute) | ✅ [Google Drive link](https://drive.google.com/file/d/16ssJqi7vh3jSoQmJ7WR9x_cNmJQLDdlN/view?usp=sharing) |
| 4 | README "privacy model" section | ✅ Detailed observer analysis above |
| 5 | Product proposal submitted | ✅ [PRODUCT_PROPOSAL.md](./PRODUCT_PROPOSAL.md) |
| 6 | Minimum 10 meaningful commits | ✅ 40+ commits |
